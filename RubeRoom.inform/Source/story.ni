...
A filling rule:
	...
	[follow describing the amphora rules for the noun;]
	
Emptying is an object based rulebook.
An emptying rule:
	now the capacity of the noun is 0; [Empty completely]
...
[Create the amphoras in the Water Room]
...
After inserting an amphora into the rock pool:
